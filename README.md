...
- **190 species** — mostly bony fish, plus fourteen sharks, three rays, a
...
- **5 rounds per game**, dealt so that every species comes up once before any
  of them comes up twice — a full pass takes 38 games, and it survives a
  refresh
...
src/fish.js             the 190 fish (name, photo URL, home region, fun fact)
...
game samples 5 of the 190 fish; raise it for a longer game that shows more of the
collection.
