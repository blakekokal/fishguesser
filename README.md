...
- **100 species** — mostly bony fish, plus eleven sharks, a stingray and a
  chimaera — each photographed alive in the wild or in an aquarium
- **15 regions**, from the Arctic Ocean to New Zealand — between four and nine
...
src/fish.js             the 100 fish (name, photo URL, home region, fun fact)
...
game samples 5 of the 100 fish; raise it for a longer game that shows more of the
collection.
