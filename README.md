...
- **269 species** — mostly bony fish, plus twenty-four sharks, eight rays, a
  sawfish, a lamprey and a chimaera, and fifty that are not fish at all:
  ...
  siphonophore, a prawn, a crayfish, a krill, a mantis shrimp, two sea stars,
  two swimming sea slugs and a horseshoe crab — each photographed alive in the
  wild, in an aquarium, or by a robot on the deep sea floor
...
- **A backup code**, which is the save written out as one line of text
  ...
  full 269-fish save near 2 KB and lets a restore match whatever species the
...
`photos.html` steps through all 269 photographs one at a time, in the same
...
src/fish.js             the 269 species (name, photo URL, home region, fact)
...
game samples 5 of the 269 species; raise it for a longer game that shows more of the
collection.
