...
- **215 species** — mostly bony fish, plus twenty-three sharks, four rays, a
...
- **5 rounds per game**, dealt so that every species comes up once before any
  of them comes up twice — a full pass takes 43 games, and it survives a
  refresh
...
src/fish.js             the 215 species (name, photo URL, home region, fact)
...
game samples 5 of the 215 species; raise it for a longer game that shows more of the
collection.
