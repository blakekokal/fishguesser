...
- **220 species** — mostly bony fish, plus twenty-four sharks, eight rays, a
  sawfish, a lamprey and a chimaera, and four that are not fish at all: two octopuses, a
...
- **5 rounds per game**, dealt so that every species comes up once before any
  of them comes up twice — a full pass takes 44 games, and it survives a
  refresh
...
src/fish.js             the 220 species (name, photo URL, home region, fact)
...
game samples 5 of the 220 species; raise it for a longer game that shows more of the
collection.
