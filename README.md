...
- **195 species** — mostly bony fish, plus fourteen sharks, three rays, a
  lamprey and a chimaera, and a handful that are not fish at all: two octopuses,
  a cuttlefish, a whale and a seal — each photographed alive in the wild or in
  an aquarium
- **15 regions**, from the Arctic Ocean to New Zealand — between five and
  seventeen species live in each, so the map has to be read rather than memorised. The header counts
...
- **5 rounds per game**, dealt so that every species comes up once before any
  of them comes up twice — a full pass takes 39 games, and it survives a
  refresh
...
src/fish.js             the 195 species (name, photo URL, home region, fact)
...
game samples 5 of the 195 species; raise it for a longer game that shows more of the
collection.
