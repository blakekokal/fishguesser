...
- **248 species** — mostly bony fish, plus twenty-three sharks, eight rays, a
  sawfish, a lamprey and a chimaera, and thirty-one that are not fish at all:
  thirteen crabs, two octopuses, a cuttlefish, a whale, two river dolphins, a
  seal, a turtle, two jellyfish and a siphonophore, a prawn, a crayfish, a
  mantis shrimp, a sea star, two swimming sea slugs and a horseshoe crab — each
  photographed alive in the wild or in an aquarium
...
- **A backup code**, which is the save written out as one line of text
  ...
  full 248-fish save near 2 KB and lets a restore match whatever species the
...
`photos.html` steps through all 248 photographs one at a time, in the same
...
src/fish.js             the 248 species (name, photo URL, home region, fact)
...
game samples 5 of the 248 species; raise it for a longer game that shows more of the
collection.
